...
describe('ExpenseTableHeader', () => {
  it('renders the Item, Category, and Amount column headings', () => {
    render(<ExpenseTableHeader totalCount={0} selectedCount={0} onToggleAll={vi.fn()} />, {
      wrapper,
    });
  ...
  it('checkbox is unchecked when no expenses are selected', () => {
    render(<ExpenseTableHeader totalCount={3} selectedCount={0} onToggleAll={vi.fn()} />, {
      wrapper,
    });
  ...
  it('checkbox is checked when all expenses are selected', () => {
    render(<ExpenseTableHeader totalCount={3} selectedCount={3} onToggleAll={vi.fn()} />, {
      wrapper,
    });
  ...
  it('checkbox is indeterminate when some but not all are selected', () => {
    render(<ExpenseTableHeader totalCount={3} selectedCount={1} onToggleAll={vi.fn()} />, {
      wrapper,
    });
    const checkbox = screen.getByRole('checkbox');
  ...
  it('calls onToggleAll(true) when the unchecked checkbox is clicked', async () => {
    ...
    render(<ExpenseTableHeader totalCount={3} selectedCount={0} onToggleAll={onToggleAll} />, {
      wrapper,
    });
  ...
  it('calls onToggleAll(false) when the checked checkbox is clicked', async () => {
    const onToggleAll = vi.fn();
    render(<ExpenseTableHeader totalCount={3} selectedCount={3} onToggleAll={onToggleAll} />, {
      wrapper,
    });
    await userEvent.click(screen.getByRole('checkbox'));
