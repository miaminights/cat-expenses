...
describe('ExpenseTableRow', () => {
  it('renders the expense name, category badge, and formatted amount', () => {
    render(
      <ExpenseTableRow expense={expense} isSelected={false} isTopCategory={false} onToggle={vi.fn()} />,
      { wrapper },
    )
  ...
  it('shows the TOP badge when isTopCategory is true', () => {
    render(
      <ExpenseTableRow expense={expense} isSelected={false} isTopCategory={true} onToggle={vi.fn()} />,
      { wrapper },
    )
  ...
  it('renders the checkbox as checked when isSelected is true', () => {
    render(
      <ExpenseTableRow expense={expense} isSelected={true} isTopCategory={false} onToggle={vi.fn()} />,
      { wrapper },
    )
  ...
  it('calls onToggle with the expense id when the checkbox is clicked', async () => {
    ...
    render(
      <ExpenseTableRow expense={expense} isSelected={false} isTopCategory={false} onToggle={onToggle} />,
      { wrapper },
    )
